        ...
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
            <div class="col-first">
                ...
                <nav class="d-flex">
                    ...
                    <a href="<?= BASE_URL ?>?act=san-pham">Sản phẩm<span class="lnr lnr-arrow-right"></span></a>
                    <span>Tìm kiếm: "<?= htmlspecialchars($_GET['q'] ?? '') ?>"</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="row mb-4">
                    <div class="col-12">
                        <h3 class="mb-3">Kết quả tìm kiếm: "<?= htmlspecialchars($_GET['q'] ?? '') ?>"</h3>
                ...
                <?php if (empty($listProduct)): ?>
                    <div class="alert alert-info">
                        ...
                        <p>Không có sản phẩm nào phù hợp với từ khóa "<?= htmlspecialchars($_GET['q'] ?? '') ?>".</p>
                        <p>Gợi ý:</p>
                        <ul>
